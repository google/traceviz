...
import { ValueType, fromV } from './value.js';
...
describe('value test', () => {
    it('converts to and from json', () => {
        ...
        // what we can.
        expect(fromV(JSON.parse(`[ 2, 0 ]`), ['hello'])).toEqual(str('hello'));
        expect(fromV(JSON.parse(`[ 4, [ 0, 1, 2] ]`), [
            'a', 'b', 'c'
        ])).toEqual(strs('a', 'b', 'c'));
...
//# sourceMappingURL=value_test.js.map