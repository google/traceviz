...
describe('trace test', () => {
    it('merges fixed time-base traces properly', () => {
        expect(prettyPrintTrace(Trace.union(Trace.fromNode(node(valueMap({ key: 'category_defined_id', val: str('x_axis') }, {
            key: 'category_display_name',
            val: str('time from start')
        }, {
            key: 'category_description',
            val: str('Time from start')
        }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(100)) }, { key: 'axis_max', val: ts(sec(300)) }), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('stuff') }, { key: 'category_display_name', val: str('Stuff') }, { key: 'category_description', val: str('Stuff') }), node(valueMap({ key: 'trace_node_type', val: int(1) }, { key: 'trace_start', val: ts(sec(100)) }, { key: 'trace_end', val: ts(sec(200)) }))), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('things') }, { key: 'category_display_name', val: str('Things') }, { key: 'category_description', val: str('Things') }), node(valueMap({ key: 'trace_node_type', val: int(1) }, { key: 'trace_start', val: ts(sec(150)) }, { key: 'trace_end', val: ts(sec(300)) }))))), Trace.fromNode(node(valueMap({ key: 'category_defined_id', val: str('x_axis') }, {
            key: 'category_display_name',
            val: str('time from start')
        }, {
            key: 'category_description',
            val: str('Time from start')
        }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(0)) }, { key: 'axis_max', val: ts(sec(220)) }), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('stuff') }, { key: 'category_display_name', val: str('Stuff') }, { key: 'category_description', val: str('Stuff') }), node(valueMap({ key: 'trace_node_type', val: int(1) }, { key: 'trace_start', val: ts(sec(0)) }, { key: 'trace_end', val: ts(sec(100)) }))), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('things') }, { key: 'category_display_name', val: str('Things') }, { key: 'category_description', val: str('Things') }), node(valueMap({ key: 'trace_node_type', val: int(1) }, { key: 'trace_start', val: ts(sec(50)) }, { key: 'trace_end', val: ts(sec(120)) }))))))))
            .toEqual(`Trace:
...
`);
    ...
    it('refuses to merge traces with incompatible time bases', () => {
        expect(() => {
            Trace.union(Trace.fromNode(node(valueMap({ key: 'category_defined_id', val: str('x_axis') }, {
                key: 'category_display_name',
                val: str('time from start')
            }, {
                key: 'category_description',
                val: str('Time from start')
            }, { key: 'axis_type', val: str('duration') }, { key: 'axis_min', val: dur(d(100)) }, { key: 'axis_max', val: dur(d(300)) }))), Trace.fromNode(node(valueMap({ key: 'trace_time_basis', val: ts(sec(0)) }, { key: 'trace_end', val: dur(d(300)) }, { key: 'category_defined_id', val: str('x_axis') }, {
                key: 'category_display_name',
                val: str('time from start')
            }, {
                key: 'category_description',
                val: str('Time from start')
            }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(100)) }, { key: 'axis_max', val: ts(sec(300)) }))));
        }).toThrow();
    });
    it('refuses to merge traces with incompatible categories', () => {
        expect(() => {
            Trace.union(Trace.fromNode(node(valueMap({ key: 'trace_end', val: dur(d(300)) }, { key: 'category_defined_id', val: str('x_axis') }, {
                key: 'category_display_name',
                val: str('time from start')
            }, {
                key: 'category_description',
                val: str('Time from start')
            }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(100)) }, { key: 'axis_max', val: ts(sec(300)) }), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('c1') }, {
                key: 'category_display_name',
                val: str('Category 1')
            }, { key: 'category_description', val: str('Category 1') })))), Trace.fromNode(node(valueMap({ key: 'trace_end', val: dur(d(300)) }, { key: 'category_defined_id', val: str('x_axis') }, {
                key: 'category_display_name',
                val: str('time from start')
            }, {
                key: 'category_description',
                val: str('Time from start')
            }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(100)) }, { key: 'axis_max', val: ts(sec(300)) }), node(valueMap({ key: 'trace_node_type', val: int(0) }, { key: 'category_defined_id', val: str('c1') }, { key: 'category_display_name', val: str('Cat. 1') }, { key: 'category_description', val: str('Category 1') })))));
        }).toThrow();
    });
    it('gets render settings properly', () => {
        expect(Trace
            .fromNode(node(valueMap({ key: 'category_defined_id', val: str('x_axis') }, {
            key: 'category_display_name',
            val: str('time from start')
        }, {
            key: 'category_description',
            val: str('Time from start')
        }, { key: 'axis_type', val: str('timestamp') }, { key: 'axis_min', val: ts(sec(100)) }, { key: 'axis_max', val: ts(sec(300)) }, { key: 'span_width_cat_px', val: int(15) }, { key: 'span_padding_cat_px', val: int(1) }, { key: 'category_header_cat_px', val: int(15) }, { key: 'category_handle_val_px', val: int(10) }, { key: 'category_padding_cat_px', val: int(1) }, { key: 'category_margin_val_px', val: int(10) }, { key: 'category_min_width_cat_px', val: int(16) }, { key: 'category_base_width_val_px', val: int(400) })))
            .renderSettings())
            .toEqual({
            spanWidthCatPx: 15,
            spanPaddingCatPx: 1,
    ...
    it('gets schedviz-like trace by merging two traces.', () => {
        const trace = Trace.union(Trace.fromNode(schedvizRunningNode), Trace.fromNode(schedvizWaitingNode));
