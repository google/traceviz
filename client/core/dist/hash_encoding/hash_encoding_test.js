...
*/
import 'jasmine';
import { int, str, ValueMap } from '../core.js';
...
describe('hash encoding test', () => {
    it('should compress and decompress an object', () => {
        ...
        expect(() => {
            const actualDecompress = decompress(actualCompressed);
    ...
    it('compresses hashes', () => {
        ...
        testCases.forEach(([compressed, evm]) => {
            ...
            expect(decompress(compressed)).toEqual(evm);
        });
    });
});
//# sourceMappingURL=hash_encoding_test.js.map