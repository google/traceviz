...
import { dur, int, ints, str, strs, ts, valueMap } from "../value/test_value.js";
    ...
    node(
      ...
      node(
        valueMap(
          ...
          {key: 'trace_payload_type', val: str('trace_edge_payload')},
  ...
  node(
    ...
    node(
      ...
      node(
        ...
        valueMap(
          {key: 'trace_node_type', val: int(3)},
          {key: 'trace_payload_type', val: str('thumbnail')},
