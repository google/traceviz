...
import {TestGlobalState} from '../../../../global_state/test_global_state';

import {ValueMapDirective} from './directives';
import {ValueMap} from '../../../../value/value_map';

import {str, strs, strSet, int, ints, intSet} from '../../../../value/test_value';
import {IntegerValue, StringValue, Value} from '../../../../value/value';
...
describe('value directives test', () => {
  ...
  it('references global Values properly', () => {
    const globalState = new TestGlobalState();
