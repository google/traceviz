...
@Directive({
  ...
  providers: [{
    provide: ValueDirective,
    useExisting: forwardRef(() => DurationLiteralDirective)
  }],
})
export class DurationLiteralDirective extends ValueDirective implements
    AfterContentInit {
  val = new Duration(0);
...
@Directive({
  ...
  providers: [{
    provide: ValueDirective,
    useExisting: forwardRef(() => TimestampLiteralDirective)
  }],
})
